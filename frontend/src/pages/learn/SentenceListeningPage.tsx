...
/**
 * SentenceListeningPage - Module 7 (例句听组)
 * User listens to sentence audio and arranges words in correct order
 */
const SentenceListeningPage: React.FC = () => {
  ...
  useEffect(() => {
    if (bookId && !session) {
      startSession(bookId, unitNumber, 7); // Module 7 = SentenceListening
    }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="flex justify-center mb-8">
          <div className="text-center">
            <p className="text-gray-600 mb-4">Listen and arrange the words:</p>
            {sentence.audioUrl && (
              <AudioButton
        ...
        {showResult && (
          <div className="mb-8 p-4 rounded-lg bg-gray-100">
            ...
            <p className="text-gray-600 mt-2">{sentence.contentCn}</p>
          </div>
        )}
...
export default SentenceListeningPage;
